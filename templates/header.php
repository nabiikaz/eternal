...
<nav class="navbar navbar-default  navbar-fixed-top" >
    ...
    <!--<img src="img/eternal_clothing_writing.png " width="100 ">-->
        ...
        <ul class="nav navbar-nav Main_Menu col-xs-5 ">
          <li class="Main_Menu_Tab " id="women_menu_title">FEMME </li>
          <li class="Main_Menu_Tab "  id="men_menu_title">HOMME </li>
        <?php 
        if(AdminPrivilegeCheck(true)){ //check if the user has an admin privilegs if true then give him the privileg to go see the dashboard menu :
            echo '<li onclick="location.href=\'dashboard.php\' " class="Main_Menu_Tab " style="margin-left: 10px; "  id="men_menu_title "> <img src="img/dashboard_icon.png " style="margin-top:-5px; " width="20 "> TABLEAU DE BORD </li>';
        }
    ...
    <div class="container-fluid End_Nav ">
          <div class="input-group col-xs-6 Middle_Nav_Menu navbar-nav navbar-left ">
                  <ul class="nav navbar-nav women_menu Menu fadeInRight animated " id="women" style="display: block; ">
                          ...
                          <li  class="Main_Sub_Menu_Tab"  id="clothing"><b>VÊTEMENTS</b>  </li>
                          <li  class="Main_Sub_Menu_Tab"  id="accessories"><b>ACCESSOIRES</b> </li>
                          <li  class="Main_Sub_Menu_Tab"  id="footware"><b>CHAUSSURES</b> </li>	
                          <li class="Main_Sub_Menu_Tab"  id="bags "><b>SACS</b> </li>
                          
                  </ul>
                   <ul class="nav navbar-nav men_menu Menu fadeInRight animated " id="men" >
                          <li class="Main_Sub_Menu_Tab"  id="clothing" id=" "><b>VÊTEMENTS</b> </li>
                          <li  class="Main_Sub_Menu_Tab"  id="accessories"><b>ACCESSORIES</b> </li>
                          <li class="Main_Sub_Menu_Tab"  id="watches"><b>MONTRES</b> </li>
                          <li  class="Main_Sub_Menu_Tab"  id="sunglasses"><b>LUNETTES</b> </li>
                          <li  class="Main_Sub_Menu_Tab "  id="footware"><b>CHAUSSURES</b> </li>
